<template>
	<view class="allBg">
		<view class="odBg">
			<view class="od-zt">
				<uni-icons type="spinner-cycle" size="48rpx" color="#fff"></uni-icons>
				<uni-icons type="info" size="48rpx" color="#fff"></uni-icons><span class="ml10">已取消</span>
			</view>
			...
			<view class="od-main">
				...
				<view class="odBox">
					...
					<view class="od-info">
						<p class="info-p">订单编号：20230906202011586734 <span @click.stop="copy(123)">复制</span></p>
						<p>下单时间：2023-09-06 20:20:11</p>
						<p>支付方式：未付款</p>
					</view>
				</view>
				...
				<view class="odBox">
					...
					<view class="od-price">
						<p>商品总价<span>￥69.60</span></p>
						<p>运费  <span>￥0.00</span></p>
					</view>
					
					<view class="od-allPrice"><span>合计：</span>￥81.90</view>
				</view>
